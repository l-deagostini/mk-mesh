  ...
  imports: [
    ConfigModule.forRoot({
      validationSchema: Joi.object({
        ...
        RABBITMQ_ADDRESS: Joi.alternatives().try(
        ...
        // MongoDB
        MONGODB_ADDRESS: Joi.alternatives().try(
          Joi.string().ip({ version: ['ipv4', 'ipv6'] }),
          Joi.string().hostname()
        ).required(),
    ...
    MongooseModule.forRoot(`mongodb://${process.env.MONGODB_ADDRESS}:${process.env.MONGODB_PORT}/`, {
